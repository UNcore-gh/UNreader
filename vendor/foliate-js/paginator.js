...
class View {
    ...
    constructor({ container, onExpand }) {
        ...
        // patched: removed sandbox to avoid Blink warning 'allow-scripts and allow-same-origin can escape sandboxing'
        // original: this.#iframe.setAttribute('sandbox', 'allow-same-origin allow-scripts')
        // no sandbox means no warning and still allows same-origin access for foliate
